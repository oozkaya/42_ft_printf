...
/*   Updated: 2018/02/22 23:48:59 by oozkaya          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	//SN_PRINTF
	...
	printf("str1_ret = %d\n", printf("|str1 = %s|\n", str1));
	printf("str2_ret = %d\n", printf("|str2 = %s|\n", str2));*/
	printf("%d\n", printf("|%s%s{red}AYDIN{1234567890088}{}{123}{green}onur|\n", "test", "test2"));
	printf("%d\n", ft_printf("|{magenta}%s{eoc}{black}%s{eoc}{cyan}{{red}}{eoc}{green}AYDIN{eoc}{yellow}{1234567890088}{}{eoc}{123}{eoc}{{green}}{red}onur{eoc}|\n", "test", "test2"));
//	printf("%d\n", printf("|%b|\n", 42));
//	printf("%d\n", ft_printf("|%08b|\n", 42));
